...
from . import users, activities, activity_types, auth, plugins, totp, notifications, manifest, favicon, media, event_info, health, websocket
...
routes_app.include_router(manifest.router, prefix="", tags=["Manifest"])
